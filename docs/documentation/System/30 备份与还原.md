...
tags: [backup, restore]
description: "Guide to Backup and Restore in Datafor"
---
...
Datafor provides **backup, restore, and backup upload** functionalities to ensure data security and availability. Users can **perform manual backups**, **schedule automatic backups**, and **upload locally stored backup packages** for restoration when needed.



## **1. Backup Content**

Datafor allows users to select from the following backup types:

- **Software**: Includes Datafor **core software and plugins**, enabling system software restoration.
...
Datafor allows users to **upload previously downloaded local backup packages** for restoration or migration.
