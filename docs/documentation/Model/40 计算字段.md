...
tags: null
description: null
createTime: 2026/09/03 22:49:31
---
...
1. Open the table's menu and select **New column**. This action is available for physical tables, not SQL Views.
2. Enter a unique **Name** that does not match a source field or another calculated column in the same table.
...
5. Click **Check and preview**. Confirm the returned values and verify that they match the selected result type; preview does not validate that type for you.
