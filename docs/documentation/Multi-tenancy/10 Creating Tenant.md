...
## 3. Tenant List Page (Multi-tenancy)
...
- **Tenant ID**: The unique identifier of the tenant (can be copied)
...
| **Admin Email**        | Yes                            | Tenant administrator email. After creation, you can change it on the **Admin** tab via **Change Admin**. |
...
<div align="left"><img src="./images/image-20260213144640627.png" width="100%"/></div>
...
<div align="left"><img src="./images/image-20260213144603556.png" width="100%"/></div>
...
> Note: Reducing the total to near or below current usage may prevent adding new users or trigger quota restrictions. Check current usage before lowering limits.
...
> Note: The UI indicates the tenant will no longer be able to use system features after expiration. Actual behavior depends on system enforcement logic.


## 7. Admin: Change Tenant Administrator

<div align="left"><img src="./images/image-20260213144621277.png" width="100%"/></div>

In the **Admin** tab, you can view and update the tenant administrator:

- View: **Current admin: xxx@xxx.com**
- Update: Click **Change Admin**, set the new admin, and save

> Recommendation: After changing the admin, notify relevant users and verify the new admin can sign in and manage the tenant successfully.
...
## 9. Enable / Disable Tenant (Disabled / Enabled)
